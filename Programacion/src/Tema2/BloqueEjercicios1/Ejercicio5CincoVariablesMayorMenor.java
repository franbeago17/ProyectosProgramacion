...
public class Ejercicio5CincoVariablesMayorMenor {
	...
	public static void main(String[] args) {
		...
		if (var1 >= var2 && var1 >= var3 && var1 >= var4 && var1 >= var5) {
			System.out.println("El mayor numero es el primero: "+var1);}
			else {
				if (var2 >= var1 && var2 >= var3 && var2 >= var4 && var2 >= var5) {
					System.out.println("El mayor numero es el segundo: "+var2);}
					else {
						if (var3 >= var1 && var3 >= var2 && var3 >= var4 && var3 >= var5) {
							System.out.println("El mayor numero es el tercero: "+var3);}
							else {
								if (var4 >= var1 && var4 >= var2 && var4 >= var3 && var4 >= var5) {
									System.out.println("El mayor numero es el cuarto: "+var4);}
									else {
		...
		if (var2 <= var1 && var2 <= var3 && var2 <= var4 && var2 <= var5) {
			System.out.println("El menor numero es el segundo: "+var2);}
				...
				if (var3 <= var1 && var3 <= var2 && var3 <= var4 && var3 <= var5) {
					System.out.println("El menor numero es el tercero: "+var3);}
					else {
						if (var4 <= var1 && var4 <= var2 && var4 <= var3 && var4 <= var5) {
							System.out.println("El menor numero es el cuarto: "+var4);}
							else {
								if (var5 <= var1 && var5 <= var2 && var5 <= var3 && var5 <= var4) {

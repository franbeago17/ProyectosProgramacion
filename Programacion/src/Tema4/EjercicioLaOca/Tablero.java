...
public class Tablero {
	...
	public static String msjPuente= "De puente a puente y tiro porque me lleva la corriente";
	public static String msjDados= "De dado a dado y tiro porque me ha tocado";
	...
	public void inicializaTablero() {
			...
			casillas[6] = new Casilla(7, "Torruga");
			...
			casillas[25] = new Casilla(26, "Dados", null, 1,msjDados);
			...
			casillas[39] = new Casilla(40, "Cestita de fresas");
			...
			casillas[51] = new Casilla(52, "Carcel", null, -2,"");
			casillas[52] = new Casilla(53, "Dados", null, 1,msjDados);
			...
			casillas[40].setDestino(casillas[44]);//Oca62
